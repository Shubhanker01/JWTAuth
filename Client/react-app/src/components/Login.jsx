            ...
            <div className="signup-form">
                <form>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" placeholder="Your Email" id="email" required></input>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" placeholder="Your Password" id="password" required></input>
                    </div>
                    <br></br>
